...
call schemacrawler.bat %scOptions% --tables="tab_groups|tab_calculation_method_rates|tab_compound_process_parameter_mapping|tab_containers|tab_container_parameters|tab_container_parameter_curves|tab_container_parameter_rates|tab_container_parameter_rhs|tab_container_parameter_values|tab_molecule_parameters|tab_parameters|tab_container_parameter_descriptor_conditions|tab_dimensions|tab_criteria_conditions" --output-file=overview_container_parameters.png
